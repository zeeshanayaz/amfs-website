...
export function AboutHero() {
    return (
        <section aria-labelledby="about-hero-heading" className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-white sm:min-h-[calc(100vh-5rem)]">
            ...
            <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-8 lg:pb-24">
                <div>
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <span className="text-[11px] font-semibold uppercase tracking-[0.3em] text-brand-sky">Our story, our purpose</span>
                    </div>
                    <h1 id="about-hero-heading" className="max-w-xl font-serif text-5xl font-semibold leading-[1.04] tracking-tight text-brand-navy text-balance sm:text-6xl lg:text-7xl">
                ...
                <div className="relative mx-auto w-full max-w-xl lg:mx-0">
                    <div className="absolute -bottom-5 -left-5 h-full w-full rounded-[2rem] bg-brand-gold/25" />
