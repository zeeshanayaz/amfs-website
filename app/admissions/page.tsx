...
const requirements = ['Completed admission inquiry or application', 'Child’s birth certificate, B-Form or identification document', 'Recent passport-size photographs', 'Previous school record, where applicable', 'Parent or guardian contact information']
    ...
    return (
        <>
            ...
            <main className="bg-brand-off-white text-brand-navy">
                ...
                <PageHeading
                    eyebrow="Admissions at AMFS"
                    title="A confident beginning for your child’s journey."
                    description="Join a school community where every child is known, encouraged, and guided to grow with purpose."
                    action={
